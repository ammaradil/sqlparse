...
SQL_REGEX = {
    'root': [
        ...
        # see https://github.com/andialbrecht/bplsqlparse/pull/64
        ...
        (r'FOR\s+\w+\s+IN\b', tokens.Keyword.ForIn),
...
KEYWORDS = {
    ...
    # 'PREFIX': tokens.Keyword,  # Removed as this is not a keyword in oracle
